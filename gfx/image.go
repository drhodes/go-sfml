...
func (self Image) Createmaskfromcolor(alpha Uint8) void { 
    return C.sfImage_createMaskFromColor();
}
...
func (self Image) Copyimage(source *Image , destX int , destY int , sourceRect IntRect, applyAlpha Bool) void { 
...
func (self Image) Fliphorizontally() void { 
    return C.sfImage_flipHorizontally();
}
...
func (self Image) Flipvertically() void { 
    return C.sfImage_flipVertically();
}
